...
//    kSKIPJACK,
  ...
  virtual SymmetricCipher* CreateEncoder(const unsigned char* key, size_t keylen,
                                         const unsigned char* iv) const = 0;
  virtual SymmetricCipher* CreateDecoder(const unsigned char* key, size_t keylen,
                                         const unsigned char* iv) const = 0;
};
